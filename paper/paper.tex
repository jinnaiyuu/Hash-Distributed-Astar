...
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{eps/efficiency.pdf}	
	\label{fig:david_speedup}
	\caption{Efficiency of HDA*}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.5\columnwidth]{eps/search_overhead.pdf}	
	\label{fig:david_so}
...
\ref{fig:hdastar_tuning}が実行結果である。どの問題サイズにおいても、Zobrist Hashとvectorによる実装が一番速いと結論出来る。
