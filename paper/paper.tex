...
Minimum Spanning Tree、およびRound Trip DistanceによるA*探索はTSPを解くには効率的な方法ではないことに注意されたい。state-of-the-artとされる手法は線形計画法による\cite{applegate2006traveling}。本研究ではHDA*、SafePBNFが木構造の探索空間でどのように振る舞うかを示すためにのみ用いる。 % TODO: よく考えたらループを持たないことは対して重要ではない。
