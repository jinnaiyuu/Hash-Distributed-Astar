...
#   set key out vert
   set key left
   plot "${data1}.correctrate.expd" u 2:1 w steps title "zobrist, vector"
   replot "${data2}.correctrate.expd" u 2:1 w steps title "zobrist, heap"
...
#   set key out vert
   set key left
   plot "${data1}.correctrate" u 2:1 w steps title "zobrist, vector"
   replot "${data2}.correctrate" u 2:1 w steps title "zobrist, heap"
