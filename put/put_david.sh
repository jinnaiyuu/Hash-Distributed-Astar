...
scp  ./src/tiles$time ./put/job_david.sh ./put/run.sh ./src/instances ./src/difficult_instances ./src/easy_instances ./src/easy_easy_instances yuu@david:/home/yuu/workspace/ethan/
