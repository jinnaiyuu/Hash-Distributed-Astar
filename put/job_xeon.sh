...
# 
i=1
for [ $i -le $problem_size ] 
do
    ./run_xeon.sh $time $algname $thread_number $osparam $i $algname.${thread_number}threads.16gbmem.${paramname}${osparam}
done
## These are the code for Lucy.
