...
print "walltime & " wall1/fs, "&", wall2/fs, "&", wall3/fs, "&", wall4/fs, "&", wall5/fs, "\\\\";
print "expansion & " expd1/fs, "&", expd2/fs, "&", expd3/fs, "&", expd4/fs, "&", expd5/fs, "\\\\";
print "load balance & " lb1/fs, "&", lb2/fs, "&", lb3/fs, "&", lb4/fs, "&", lb5/fs, "\\\\";
print "node send ratio & " push1/fs, "&", push2/fs, "&", push3/fs, "&", push4/fs, "&", push5/fs;
}' $1 $2 $3 $4 $5
